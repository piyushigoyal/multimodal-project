...
if __name__ == '__main__':
    ...
    inp_file = "LVLM-Playground/benchmark/perceive/tictactoe/annotation.json"
    output_file = "gen_qa_set/tictactoe.jsonl"
    ...
    # Define your QA system (assumed to exist)
    qa_system = TicTacToeQuestionAnswering('Here is a screenshot of a Tic Tac Toe game.')
    ...
    for item in lines:
        ...
        board = [[gt[row][col] for col in range(3)] for row in range(3)]
        # print(f"board:{board}")
