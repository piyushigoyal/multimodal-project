...
if __name__ == '__main__':
    ...
    inp_file = "LVLM-Playground/benchmark/perceive/sudoku/annotation.json"
    output_file = "gen_qa_set/sudoku.jsonl"
    ...
    qa_system = SudokuQuestionAnswering('Here is a screenshot of a Sudoku game.')
    ...
    for item in lines:
        ...
        board = [[gt[row][col] for col in range(9)] for row in range(9)]
        # print(f"board:{board}")
